...
class MidiProExample extends StatefulWidget {
  const MidiProExample({super.key});

  @override
  State<MidiProExample> createState() => _MidiProExampleState();
}

class _MidiProExampleState extends State<MidiProExample> {
  ...
  final sf2Paths = ['assets/soundfonts/The_Ultimate_Megadrive_Soundfont.sf2'];
  @override
